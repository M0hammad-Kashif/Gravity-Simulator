...
""" Mohammad Kashif
B.Tech(First year) , Computer Science student at Jamia Millia Islamia , New Delhi"""



import tkinter
from tkinter import CURRENT,END
...
#define layout of gravity simulator
#creating frames
...
#horizontal line
hr_line_1 = main_canvas.create_line(2,2,400,2)
hr_line_2 = main_canvas.create_line(2,415,400,415 )
...
# Row labels
tkinter.Label(input_frame,text="d").grid(row=0,column=0,ipadx=22)
tkinter.Label(input_frame,text="vi").grid(row=1,column=0,ipadx=22)
tkinter.Label(input_frame,text="a").grid(row=2,column=0,ipadx=22)
tkinter.Label(input_frame,text="t").grid(row=3,column=0,ipadx=22)


#height(distance/displacement) label
heights = {}
for i in range (1,5):
...
t_slider = tkinter.Scale(input_frame, from_=0, to=1, tickinterval=0.1, resolution=0.01, orient="horizontal", activebackground="red")
